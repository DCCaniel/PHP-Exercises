...
$result = $redLight ? "<p>Stop the car!</p>" : "<p>You can make it!</p>";
echo $result;
...
if (($redLight === true or $yellowLight === true) and $greenLight === false) {
	echo "Stop the car!";
...
$light = true; // Value as "true", will be treated as the first case expecting a string, NOT default. It should output as "Stop the car!"
...
switch ($light) {
	...
	case "green":
		...
		break;
	default:
		echo "Traffic lights are messed up! Use common sense and stay safe!";
		break;
}
?>