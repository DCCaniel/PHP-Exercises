...
$expressionTwo = "My name is $firstName $lastName. I was born on $day of $month in $year.";
$assembled = $expressionTwo;
/*
Print assembled.
*/    
...
$expressionThree = $price+($price*$tax)+($price*$delivery);
$total = $expressionThree;
...
<figure>
	<img src="https://placehold.jp/24/e8d2ae/fff/300x300.png" alt="placeholder-image">
	<figcaption> <?php print "armchair: $total"; ?> </figcaption>
</figure>